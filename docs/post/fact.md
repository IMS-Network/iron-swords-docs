...
## איך לפרסם פוסט במדור עובדה

<iframe 
  src="https://www.wizardshot.com/embed/tutorials/18094-navigating-to-the-facts-section-and-adding-a-new-fact" 
  style={{
    width: '100%', 
    height: '950px',
    border: 'none', 
...
#### קטגוריה
המערכת מגדירה את הקטגוריה של הפוסט באופן אוטומטי למדור עובדה
#### תגיות
